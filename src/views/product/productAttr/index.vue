  ...
  export default {
    ...
    methods: {
      ...
      getAttrList(index, row) {
        this.$router.push({path: '/product/productskulist',query:{cid:row.id,cname:row.name,type:0}})
      },
      getParamList(index, row) {
        this.$router.push({path: '/product/productskulist',query:{cid:row.id,cname:row.name,type:1}})
      },
