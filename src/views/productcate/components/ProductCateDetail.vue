  ...
  <el-card class="form-container" shadow="never">
    <el-form :model="productCate"
      ...
      <el-form-item label="排序：">
        <el-input v-model="productCate.sort_num"></el-input>
      </el-form-item>
      ...
      <el-form-item label="是否显示在导航栏：">
        <el-radio-group v-model="productCate.show_navigation">
          <el-radio :label="1">是</el-radio>
          <el-radio :label="0">否</el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item label="是否显示首页顶部：">
        <el-radio-group v-model="productCate.show_home">
          <el-radio :label="1">是</el-radio>
          <el-radio :label="0">否</el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item label="是否显示首页活动：">
        <el-radio-group v-model="productCate.show_home_recommend">
          <el-radio :label="1">是</el-radio>
          <el-radio :label="0">否</el-radio>
        </el-radio-group>
      </el-form-item>
    ...
    methods: {
      getSelectProductCateList() {
        fetchList(0, {list_row: 100, page: 1}).then(response => {
          this.selectProductCateList = response.list;
