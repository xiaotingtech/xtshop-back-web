...
<script>
  import {fetchTreeList} from '@/api/node';
      ...
      handleSave() {
        ...
        if(checkedNodes!=null&&checkedNodes.length>0){
          for(let i=0;i<checkedNodes.length;i++){
            ...
            checkedMenuIds.add(checkedNode.id+'_'+checkedNode.level);
            if(checkedNode.parentId!==0){
              checkedMenuIds.add(checkedNode.parentId+'_'+(parseInt(checkedNode.level)-1));
            }
          }
        }
